/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 322b6d6bee27e22c0e5b9d10662908ef)
// Runtime types generated with workerd@1.20250705.0 2025-05-23 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		HOSTNAME_PATTERN: "http://<CONTAINER_ID>.localhost:8787" | "https://<CONTAINER_ID>.sandboxes.not-single-bug.com";
		SANDBOX_CONTAINERS: DurableObjectNamespace<import("./src/index").Sandbox>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "HOSTNAME_PATTERN">> {}
}
